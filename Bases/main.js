...
define("Clases/Basicos", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /*(()=>{
        class coche{
    ...
    (() => {
        class numerosPares {
            constructor(numeros) {
                this.lista = new numerosPares([3, 4, 6, 8, 6, 4, 3, 8]);
...
define("E6/ForOf", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    (() => {
        const ironman = {
